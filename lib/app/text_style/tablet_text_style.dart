...
class TabletTextStyle extends AppTextStyle {
  @override
  TextStyle get bodyB =>
  ...
  TextStyle get titleL =>
      const TextStyle(fontSize: 21, fontWeight: FontWeight.w300);
  ...
  TextStyle get titleT =>
      const TextStyle(fontSize: 21, fontWeight: FontWeight.w100);
}
